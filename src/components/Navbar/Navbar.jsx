...
const Navbar = () => {
    const links = <>
        ...
        <Link to={'/about'}><li className="btn"> About</li></Link>
        <Link to={'/readList'}><li className="btn"> Read List</li></Link>
        <Link ><li className="btn">Listed Book</li></Link>
        <Link ><li className="btn">Pages to Read</li></Link>
    </>
    return (
